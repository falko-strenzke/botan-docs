...
:srcref:`[src/lib/pubkey/classic_mceliece]/cmce_keys_internal.cpp`).
It works as follows:
...
The Classic McEliece encapsulation procedure (:srcref:`[src/lib/pubkey/classic_mceliece]/cmce_encaps.cpp`)
...
The Classic McEliece decapsulation procedure (:srcref:`[src/lib/pubkey/classic_mceliece]/cmce_decaps.cpp`)
